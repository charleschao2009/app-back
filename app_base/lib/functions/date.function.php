...
class seccode {
	...
	private $font_type = array(
		0 => FONT_DIR.'TrajanPro-Bold.otf',
		1 => FONT_DIR.'StencilStd.otf',
		2 => FONT_DIR.'VINERITC.TTF'
	);
	...
	function __construct()
	{
		...
		$this -> str['upper'] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
		$this -> str['lower'] = "abcdefghijklmnopqrstuvwxyz";
		$this -> str['alpha'] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
		$this -> str['num'] = "0123456789";
	} 
	// 配置
